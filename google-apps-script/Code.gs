...
function addQrCode(v) { const id=String(v['Visitor ID']||'');return Object.assign({},v,{qr_value:id,qr_url:'https://api.qrserver.com/v1/create-qr-code/?size=240x240&data='+encodeURIComponent(id)}); }
